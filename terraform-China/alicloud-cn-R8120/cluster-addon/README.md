...
Terraform module which add on a Check Point CloudGuard Network Security Cluster into an existing VPC.
...
| gateway_version | Gateway version and license | string | - R8120-BYOL | R8120-BYOL | no |
