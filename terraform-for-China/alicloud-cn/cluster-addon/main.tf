...
module "common_cluster_primary_eip" {
  ...
  instance_id = alicloud_instance.member-a-instance.id
  eip_name = format("%s-addon-primary-eip", var.resources_tag_name != "" ? var.resources_tag_name : var.gateway_name)
}
module "common_cluster_secondary_eip" {
  ...
  allocate_and_associate_eip = true
  instance_id = alicloud_instance.member-b-instance.id
  eip_name = format("%s-addon-secondary-eip", var.resources_tag_name != "" ? var.resources_tag_name : var.gateway_name)
}
